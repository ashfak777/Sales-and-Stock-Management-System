 ...
 * @author DELL
 */
@WebServlet(name = "allcake", urlPatterns = {"/allcake"})
public class allcake extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        for(int j=0;j<pages;j++){
            button+="<td><input type=\"button\" value=\""+(j+1)+"\" onclick=\"search("+(j*15)+")\" class=\"btn btn-primary\"></td>";
        }
