     ...
     <!--end header-->
        ...
        <section class="container" style="margin-top: 150px">
            <% 
             ...
             UserType ut=(UserType)s.load(UserType.class, 2);
        ...
        <script type="text/javascript">
            ...
            function load(){
                        ...
                        // table.setAttribute("id","main");
                         ...
                         for(var i=0;i<array.length; i++){
                             var u=array[i];
                               ...
                               button.setAttribute("onclick","save("+u.uid+")");
                ...
                request.open("GET","adminallseller?search_object="+JSON.stringify(search_object),true);
                request.send();
            }
           ...
           function save(id){
                ...
                request.open("GET","sellercontrol?id="+id,true);
                request.send();
            }
