     ...
     <!--end header-->
        ...
        <section class="container" style="margin-top: 150px">
            ...
            <% 
              ...
              cr.add(Restrictions.eq("status","notactive"));
              ...
              for(UserRegistration u:ur){
                  %>
                <tr><td><%=u.getFname()%> <%=u.getLname() %></td><td><%=u.getEmail() %></td><td><%=u.getMobile() %></td><td><%=u.getRegisterDate() %></td><td><button class="btn btn-color" onclick="save(<%= u.getUid() %>)">Accept</button></td></tr>
                  <%
              }
            %>
            </table>
