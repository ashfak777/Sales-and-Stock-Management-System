    ...
    <%@include file="admin_header.jsp" %>
     <!--end header-->
        ...
        <section class="container" style="margin-top: 150px">
            <center>
            <span class="radio-inline">Received message</span><input type="radio" name="type" onchange="load()">&nbsp;&nbsp;&nbsp;
            <span class="radio-inline">Send message</span><input type="radio" name="type" onchange="load1()">
            </center>
            <div id="main">
        ...
        <script type="text/javascript">
           function receiveload(){
            ...
            function load(){
                ...
                request.open("GET","adminmsg",true);
                request.send();
            }
             function load1(){
                 document.getElementById("main").innerHTML="";
                ...
                request.open("GET","adminsendmsg",true);
                request.send();
            }
